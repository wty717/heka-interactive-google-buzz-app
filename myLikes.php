...
// Get the my liked stream (the activities which I have liked) for @me, which means 'the authenticated user', using $buzz->listActivities()
$activities = $buzz->listActivities('@liked', '@me', 50, 50, null, 50);
