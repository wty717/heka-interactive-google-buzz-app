...
// Get the public stream (the activities from everyone) for @me, which means 'the authenticated user', using $buzz->listActivities()
$activities = $buzz->listActivities('@public', '@all', 50, 50, null, 50);
