...
// Get the my comments stream (the activities that I comment on) for @me, which means 'the authenticated user', using $buzz->listActivities()
$activities = $buzz->listActivities('@comments', '@me', 50, 50, null, 50);
