...
$apiConfig = array(
    ...
    'site_name' => 'buzz.hekainteractive.com',
    ...
    'oauth_consumer_key'    => 'buzz.hekainteractive.com',
    'oauth_consumer_secret' => 'AR9LdbgW8o+uKDGSfLDTaGml',
...
// Get the signed in users [USER ID]
$userID = '';

// Place the [USER ID] into a session or cookie (Find out which is best)
